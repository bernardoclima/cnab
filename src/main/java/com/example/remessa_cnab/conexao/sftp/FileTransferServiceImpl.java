...
public class FileTransferServiceImpl implements FileTransferService {
    ...
    @Value("${citi.cobranca.sftp.host}")
    private String host;

    @Value("${citi.cobranca.sftp.port}")
    private Integer port;

    @Value("${citi.cobranca.sftp.username}")
    private String username;

    @Value("${citi.cobranca.sftp.password}")
    private String password;

    @Value("${citi.cobranca.sftp.sessionTimeout}")
    private Integer sessionTimeout;

    @Value("${citi.cobranca.sftp.channelTimeout}")
